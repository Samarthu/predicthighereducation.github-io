            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li  class="active"><a href="test_rpt.php">Test Details</a></li>
	...
	<div class="container">
		<div class="row">
			...
			<table class="table table-striped table-condensed table-bordered">
				<tr>
					<th>Name</th><th>Test Type</th><th>Score</th><th>Outoff</th>
					
				</tr>
				<?php
					$rs=$db->prepare("select s.name,m.ttype,m.score,m.outoff from tbl_student s join tbl_score m where s.username=m.username");
  					$rs->execute();  					
  					while($row=$rs->fetch())
				  	{
				  	  echo "<tr>";		
