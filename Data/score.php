...
<div id="wrapper" class="home-page">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">Score for <?php echo $_POST['ttype'];?> Test</h2>				
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
                ...
                $outoff=$cnt*2;
 			  if($db->exec("insert into tbl_score values('$student','$ttype','$score','$outoff')"))
  			  {
	            echo "Total Scroe is : ". $score;
              }
              else
              {
                  echo "Score not calculated";
              }		
			?>
			
				<a href="take_test.php">Back for Another Test</a>
